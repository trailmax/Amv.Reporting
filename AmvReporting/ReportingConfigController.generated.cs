...
namespace AmvReporting.Controllers
{
    ...
    public partial class T4MVC_ReportingConfigController : AmvReporting.Controllers.ReportingConfigController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, AmvReporting.Domain.ReportingConfigs.Commands.UpdateConfigurationCommand command);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(AmvReporting.Domain.ReportingConfigs.Commands.UpdateConfigurationCommand command)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
